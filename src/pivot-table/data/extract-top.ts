  ...
  function recursiveExtract(
    ...
    nodes.forEach((node, currColIdx) => {
      ...
      const cell = createCell(
        ...
        layoutService.colorByExpressionIndex.topDimensions[rowIdx] // TODO For a chart without top dimensions, this is still called for the measure header. Which will throw an exception later
      );
