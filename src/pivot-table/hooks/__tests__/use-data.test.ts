...
import { TopDimensionData, MeasureData, LeftDimensionData, HeadersData } from '../../../types/types';
...
describe('useData', () => {
  // Top data mockes
  let mockedAddPageToTopDimensionData: jest.MockedFunction<(prevData: TopDimensionData, nextDataPage: EngineAPI.INxPivotPage) => TopDimensionData>;
  let mockedCreateTopDimensionData: jest.MockedFunction<(dataPage: EngineAPI.INxPivotPage, qHyperCube: EngineAPI.IHyperCube, isSnapshot: boolean) => TopDimensionData>;
  // Measure data mocks
  let mockedAddPageToMeasureData: jest.MockedFunction<(prevData: MeasureData, nextDataPage: EngineAPI.INxPivotPage) => MeasureData>;
  let mockedCreateMeasureData:  jest.MockedFunction<(dataPage: EngineAPI.INxPivotPage, isSnapshot: boolean) => MeasureData>;
  // Left data mocks
  let mockedAddPageToLeftDimensionData: jest.MockedFunction<(prevData: LeftDimensionData, nextDataPage: EngineAPI.INxPivotPage) => LeftDimensionData>;
  let mockedCreateLeftDimensionData: jest.MockedFunction<(dataPage: EngineAPI.INxPivotPage, qHyperCube: EngineAPI.IHyperCube, isSnapshot: boolean) => LeftDimensionData>;
  // Header data mocks
  let mockedCreateHeadersData: jest.MockedFunction<(qHyperCube: EngineAPI.IHyperCube, rowCount: number, dimensionInfoIndexMap: number[]) => HeadersData>;
  ...
  beforeEach(() => {
    mockedAddPageToTopDimensionData = addPageToTopDimensionData as jest.MockedFunction<typeof addPageToTopDimensionData>;
    ...
    mockedAddPageToLeftDimensionData = addPageToLeftDimensionData as jest.MockedFunction<typeof addPageToLeftDimensionData>;
