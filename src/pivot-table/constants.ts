...
export const DEFAULT_FONT_COLOR = "#404040"; // TODO this is the default dimension color and null value color, for measure values the default is rgba(0, 0, 0, 0.55)
export const DEFAULT_BACKGROUND_COLOR = "transparent";
export const DEFAULT_CELL_HEIGHT = 28;
export const DEFAULT_LINE_CLAMP = 1;

export const MAX_ROW_COUNT = 15_000;
